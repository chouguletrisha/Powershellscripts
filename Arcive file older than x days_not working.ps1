...
$Now = Get-Date 
$Days = "15" 
$TargetFolder = "C:\Users\300524\Desktop\Powershellscripts" #logs folder on the server 
$Extension = "*.ps1" #change extension to txt or other 
$LastWrite = $Now.AddDays(-$Days) 
$BackupLocation = "C:\Users\300524\Desktop\Powershellscripts\Archived" #change this line to your backup destination 
